package com.viki.org.apache.curator.framework.recipies.nodes;
...
public class PersistentEphemeralNodeExample {
    private static final String PATH = "/example/ephemeralNode3";
    private static final String PATH2 = "/example/node2";
